  ...
  return (
    <div className="searchbar">
      <form>
        ...
        &nbsp; &nbsp; 
        <label>From: </label>
        <input placeholder="YYYY-MM" name="fromDate" value={form.fromDate} type="search" onChange={(e)=>handleChange(e)}></input>
        &nbsp; &nbsp; 
        <label>To: </label>
        <input placeholder="YYYY-MM" name="toDate" value={form.toDate} type="search" onChange={(e)=>handleChange(e)}></input>
        &nbsp;&nbsp;
